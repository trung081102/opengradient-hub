...
export default function RegisterPage() {
  ...
  const { signUp, signInWithGitHub, signInWithGoogle, isConfigured } = useAuth();
    ...
    return (
      <div className="min-h-screen bg-og-dark flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          <div
            className="w-16 h-16 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-6"
            style={{ background: 'linear-gradient(135deg, #8B5CF6, #00D4AA)' }}
          >
            &#10003;
          </div>
          <h1 className="text-white text-2xl font-bold mb-2">Check your email</h1>
          <p className="text-og-text-secondary mb-6">
            We sent a confirmation link to <span className="text-white">{email}</span>.
            Click it to verify your account.
          </p>
          <Link
            href="/login"
            className="inline-block px-6 py-2.5 bg-og-purple hover:bg-og-purple-dark text-white rounded-lg font-medium text-sm transition-colors"
          >
            Back to Login
          </Link>
        </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-og-text-secondary mt-2 text-sm">
            Join the Verifiable AI community
          </p>
        </div>

        {/* Card */}
        <div className="bg-og-card border border-og-border rounded-xl p-6">
          <h1 className="text-white text-xl font-bold mb-6 text-center">Create your account</h1>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-og-text-muted text-xs">or register with email</span>
            <div className="flex-1 h-px bg-og-border" />
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label htmlFor="username" className="block text-og-text-secondary text-sm mb-1.5">
                  Username *
                </label>
                <input
                  id="username"
              ...
              <div>
                <label htmlFor="displayName" className="block text-og-text-secondary text-sm mb-1.5">
                  Display Name
                </label>
                <input
                  id="displayName"
          ...
          <p className="text-center text-og-text-secondary text-sm mt-6">
            ...
            <Link href="/login" className="text-og-purple hover:text-og-purple-light transition-colors">
              Sign in
            </Link>
          </p>
        </div>
